	...
	public main() {
		...
		do {
			...
			case 1:
				...
				id = new StringBuilder().append(huruf).append(huruf1)+"-"+String.format("%04d", random);
				int banding = 0;
				...
				do {
					if (tahu == false) {
						for (String str : stringList3) {
							if (str.equals(id)) {
								String id1 = new StringBuilder().append(huruf).append(huruf1) + "-" + String.format("%04d", random);
								id = id1;
								banding = 0;
								break;
							} else {
			...
			case 3:
				...
				int random1 = (int) (Math.random()*9999);
				id2 = new StringBuilder().append(huruf2).append(huruf3)+"-"+String.format("%04d", random1);
				...
				do {
					if (tahu1 == false) {
						for (String str : stringList3) {
							if (str.equals(id2)) {
								String id3 = new StringBuilder().append(huruf2).append(huruf3) + "-" + String.format("%04d", random1);
								id2 = id3;
								banding1 = 0;
								break;
							} else {
